...
| Fired risks and failing gates | **K2** (RT-01 structural ops; ADR-004a, WP-1.1a: M1 at 2.05×, not met), **K39** (RT-13 fuel identity and overhead; WP-0.10r) and **K5b** (armed by WP-0.9c's red outcome; `pcg_tests_perf` fails by design) | §7. K3's hazard was found and mitigated in spike (a) |
