// Private header: pins floating-point code generation for the attribute aggregation (06 §1.2
...
#error "engine/gameplay must not be compiled with -ffast-math (06 §1.2)"
#endif
